...
! function (e, t) {
    ...
    var t = function (e, t) {
        ...
        W = {
            array: function (e) {
                ...
                return M(e) ? [] : b(e) ? e : C(e).split(t).map(w).filter(function (e) {
                    return e.length
                })
            },
            boolean: G,
    ...
    var ce, fe, de = function (e, t) {
            ...
            return {
                GET_STATUS: function () {
                    var t = be(e.items),
                        ...
                        i = Me.IDLE,
                        a = Me.READY;
                    return 0 === t.length ? n : t.some(Ue) ? r : t.some(Be) ? o : t.some(qe) ? a : i
                },
                GET_ITEM: function (t) {
                    return Le(e.items, t)
                },
                GET_ACTIVE_ITEM: function (t) {
                    return Le(be(e.items), t)
                },
                ...
                GET_ITEMS_BY_STATUS: function (t) {
                    return be(e.items).filter(function (e) {
                        return e.status === t
                    })
                },
                GET_TOTAL_ITEMS: function () {
                    return be(e.items).length
                },
        ...
        We = function (e, t) {
            ...
            return o.lastModifiedDate = new Date, e._relativePath && (o._relativePath = e._relativePath), U(t) || (t = Xe()), t && null === r && ke(t) ? o.name = t : (r = r || function (e) {
            ...
            var t = {
                ...
                n = function (n) {
                    e ? (t.timestamp = Date.now(), t.request = e(n, function (e) {
                        t.duration = Date.now() - t.timestamp, t.complete = !0, e instanceof Blob && (e = We(e, e.name || je(n))), r.fire("load", e instanceof Blob ? e : e ? e.body : null)
                    }, function (e) {
                    ...
                    if (!T.aborted)
                        if (t = t || f.find(L)) {
                            ...
                            c.onload = function () {
                                ...
                                t.status = dt, t.request = null, t.error = o(e.response) || e.statusText, b(t) || a(ot("error", e.status, o(e.response) || e.statusText, e.getAllResponseHeaders()))
                            }, c.ontimeout = function (e) {
                                t.status = dt, t.request = null, b(t) || it(a)(e)
                            }, c.onabort = function () {
                ...
                f = Object.assign({
                    ...
                    load: function (t, n, r) {
                        i.source = t, f.fireSync("init"), i.file ? f.fireSync("load-skip") : (i.file = function (e) {
                            ...
                            return e instanceof Blob || Ye(e) ? t[0] = e.name || Xe() : Ye(e) ? (t[1] = e.length, t[2] = Qe(e)) : U(e) && (t[0] = je(e), t[1] = 0, t[2] = "application/octet-stream"), {
                                name: t[0],
                                size: t[1],
                                type: t[2]
                            }
                    ...
                    process: function e(t, n) {
                        if (i.processingAborted) i.processingAborted = !1;
                            ...
                            t.on("load", function (e) {
                                ...
                                i.activeProcessor = null, i.transferId = null, i.serverFileReference = e, u(Ie.IDLE), l("process-abort"), a && a()
        ...
        bt = function (e, n, r) {
            return {
                ...
                DID_SET_FILES: function (t) {
                    ...
                    }), i = be(r.items), o.forEach(function (t, n) {
                        i.find(function (e) {
                ...
                DID_UPDATE_ITEM_METADATA: function (t) {
                    ...
                    a.silent || (clearTimeout(r.itemUpdateTimeout), r.itemUpdateTimeout = setTimeout(function () {
                        var t = Rt(r.items, o);
                        if (n("IS_ASYNC")) {
                            t.origin === ve.LOCAL && e("DID_LOAD_ITEM", {
                                id: t.id,
                                error: null,
                                serverFileReference: t.source
                            });
                            var s, u = function () {
                                setTimeout(function () {
                            ...
                            return t.status === Ie.PROCESSING_COMPLETE ? (s = r.options.instantUpload, void t.revert(Tt(r.options.server.url, r.options.server.revert), n("GET_FORCE_REVERT")).then(s ? u : function () {}).catch(function () {})) : t.status === Ie.PROCESSING ? function (e) {
                ...
                MOVE_ITEM: function (e) {
                    ...
                    if (o) {
                        ...
                        i !== (n = xe(n, 0, r.items.length - 1)) && r.items.splice(n, 0, r.items.splice(i, 1)[0])
                    }
                },
                SORT: function (t) {
                    var o = t.compare;
                    Lt(r, o), e("DID_SORT_ITEMS", {
                ...
                ADD_ITEM: function (t) {
                    ...
                    if (M(o)) f({
                    ...
                    else if (!ht(o) || !r.options.ignoredFiles.includes(o.name.toLowerCase())) {
                        if (! function (e) {
                                var t = be(e.items).length;
                            ...
                            if (_.status === Ie.PROCESSING_COMPLETE || _.status === Ie.PROCESSING_REVERT_ERROR) {
                                ...
                                if (_.revert(Tt(r.options.server.url, r.options.server.revert), T).then(function () {
                                        T && e("ADD_ITEM", {
                                            source: o,
                                            index: a,
                                            interactionMethod: s,
                        ...
                        v.on("init", function () {
                            ...
                            var n = yt(r.options.labelFileLoadError)(t);
                            ...
                            Oe("DID_LOAD_ITEM", v, {
                                ...
                                At(n("GET_BEFORE_ADD_FILE"), Te(v)).then(t)
                            }).catch(function (n) {
                                if (!n || !n.error || !n.status) return t(!1);
                                e("DID_THROW_ITEM_INVALID", {
                                    id: h,
                                    error: n.error,
                                    status: n.status
                            ...
                            e("DID_THROW_ITEM_PROCESSING_ERROR", {
                                ...
                                error: t,
                                status: {
                                    main: yt(r.options.labelFileProcessingError)(t),
                                    sub: r.options.labelTapToRetry
                                }
                            })
                            ...
                            e("DID_THROW_ITEM_PROCESSING_REVERT_ERROR", {
                                ...
                                error: t,
                                status: {
                                    main: yt(r.options.labelFileProcessingRevertError)(t),
                                    sub: r.options.labelTapToRetry
                                }
                            })
                        ...
                        v.load(o, tt(I === ve.INPUT ? U(o) && function (e) {
                            return (e.indexOf(":") > -1 || e.indexOf("//") > -1) && Dt(location.href) !== Dt(e)
                        }(o) && y ? ut(R, y) : Ot : ut(R, I === ve.LIMBO ? D : O)), function (e, t, r) {
                            Oe("LOAD_FILE", e, {
                                query: n
                            }).then(t).catch(r)
                        })
                ...
                COMPLETE_LOAD_ITEM: function (t) {
                    var o = t.item,
                        ...
                        a = i.success,
                        s = i.source,
                        u = n("GET_ITEM_INSERT_LOCATION");
                    if (Y(u) && s && Lt(r, u), e("DID_LOAD_ITEM", {
                            id: o.id,
                            error: null,
                ...
                RETRY_ITEM_LOAD: Pt(r, function (e) {
                    e.retryLoad()
                }),
                REQUEST_ITEM_PREPARE: Pt(r, function (t, n, r) {
                ...
                REQUEST_ITEM_PROCESSING: Pt(r, function (t, o, i) {
                    if (t.status === Ie.IDLE || t.status === Ie.PROCESSING_ERROR) t.status !== Ie.PROCESSING_QUEUED && (t.requestProcessing(), e("DID_REQUEST_ITEM_PROCESSING", {
                        ...
                        t.status === Ie.PROCESSING_COMPLETE || t.status === Ie.PROCESSING_REVERT_ERROR ? t.revert(Tt(r.options.server.url, r.options.server.revert), n("GET_FORCE_REVERT")).then(s).catch(function () {}) : t.status === Ie.PROCESSING && t.abortProcessing().then(s)
                    }
                }),
                PROCESS_ITEM: Pt(r, function (t, o, i) {
                    ...
                    if (n("GET_ITEMS_BY_STATUS", Ie.PROCESSING).length !== a) {
                        if (t.status !== Ie.PROCESSING) {
                            ...
                            t.onOnce("process-complete", function () {
                                o(Te(t)), s();
                                var i = r.options.server;
                                if (r.options.instantUpload && t.origin === ve.LOCAL && Y(i.remove)) {
                                    var a = function () {};
                                    t.origin = ve.LIMBO, r.options.server.remove(t.source, a, a)
                                }
                                n("GET_ITEMS_BY_STATUS", Ie.PROCESSING_COMPLETE).length === r.items.length && e("DID_COMPLETE_ITEM_PROCESSING_ALL")
                            ...
                            var u = r.options;
                            t.process(vt(_t(u.server.url, u.server.process, u.name, {
                ...
                RETRY_ITEM_PROCESSING: Pt(r, function (t) {
                    e("REQUEST_ITEM_PROCESSING", {
                        query: t
                    })
                }),
                REQUEST_REMOVE_ITEM: Pt(r, function (t) {
                    At(n("GET_BEFORE_REMOVE_FILE"), Te(t)).then(function (n) {
                        n && e("REMOVE_ITEM", {
                            query: t
                        })
                    })
                }),
                RELEASE_ITEM: Pt(r, function (e) {
                    e.release()
                }),
                REMOVE_ITEM: Pt(r, function (t, o, i, a) {
                    var s = function () {
                            var n = t.id;
                            Rt(r.items, n).archive(), e("DID_REMOVE_ITEM", {
                                error: null,
                                id: n,
                                item: t
                            }), St(e, r), o(Te(t))
                        ...
                        u = r.options.server;
                    t.origin === ve.LOCAL && u && Y(u.remove) && !1 !== a.remove ? (e("DID_START_ITEM_REMOVE", {
                        id: t.id
                    }), u.remove(t.source, function () {
                        return s()
                    }, function (n) {
                        e("DID_THROW_ITEM_REMOVE_ERROR", {
                            id: t.id,
                            error: ot("error", 0, n, null),
                            status: {
                                main: yt(r.options.labelFileRemoveError)(n),
                                sub: r.options.labelTapToRetry
                            }
                        })
                    })) : (a.revert && t.origin !== ve.LOCAL && null !== t.serverId && t.revert(Tt(r.options.server.url, r.options.server.revert), n("GET_FORCE_REVERT")), s())
                }),
                ABORT_ITEM_LOAD: Pt(r, function (e) {
                    e.abortLoad()
                }),
                ABORT_ITEM_PROCESSING: Pt(r, function (t) {
                ...
                REQUEST_REVERT_ITEM_PROCESSING: Pt(r, function (t) {
                ...
                REVERT_ITEM_PROCESSING: Pt(r, function (t) {
                    t.revert(Tt(r.options.server.url, r.options.server.revert), n("GET_FORCE_REVERT")).then(function () {
        ...
        qt = function (e) {
            var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : ".",
                ...
                o = n * n,
                i = n * n * n;
            return (e = Math.round(Math.abs(e))) < r ? e + " bytes" : e < o ? Math.floor(e / r) + " KB" : e < i ? Ft(e / o, 1, t) + " MB" : Ft(e / i, 2, t) + " GB"
        },
        Ft = function (e, t, n) {
        ...
        Vt = function (e) {
            var t = e.root,
                n = e.props;
            Ct(t.ref.fileSize, qt(t.query("GET_ITEM_SIZE", n.id), ".", t.query("GET_FILE_SIZE_BASE"))), Ct(t.ref.fileName, Mt(t.query("GET_ITEM_NAME", n.id)))
        },
        xt = function (e) {
            var t = e.root,
                n = e.props;
            V(t.query("GET_ITEM_SIZE", n.id)) ? Vt({
                root: t,
                props: n
            }) : Ct(t.ref.fileSize, t.query("GET_LABEL_FILE_SIZE_NOT_AVAILABLE"))
        },
        Yt = S({
            name: "file-info",
            ignoreRect: !0,
            ...
            create: function (e) {
                ...
                var i = wt("span");
                i.className = "filepond--file-info-sub", t.appendChild(i), t.ref.fileSize = i, Ct(i, t.query("GET_LABEL_FILE_WAITING_FOR_SIZE")), Ct(o, Mt(t.query("GET_ITEM_NAME", n.id)))
            },
            mixins: {
        ...
        kt = function (e) {
            ...
            Ct(t.ref.main, r), Ct(t.ref.sub, t.query("GET_LABEL_TAP_TO_CANCEL"))
        },
        Ht = function (e) {
            var t = e.root;
            Ct(t.ref.main, ""), Ct(t.ref.sub, "")
        },
        Xt = function (e) {
            var t = e.root,
                n = e.action;
            Ct(t.ref.main, n.status.main), Ct(t.ref.sub, n.status.sub)
        },
        Wt = S({
            name: "file-status",
            ignoreRect: !0,
            ...
            write: A({
                ...
                DID_REQUEST_ITEM_PROCESSING: function (e) {
                    var t = e.root;
                    Ct(t.ref.main, t.query("GET_LABEL_FILE_PROCESSING")), Ct(t.ref.sub, t.query("GET_LABEL_TAP_TO_CANCEL"))
                },
                DID_ABORT_ITEM_PROCESSING: function (e) {
                    var t = e.root;
                    Ct(t.ref.main, t.query("GET_LABEL_FILE_PROCESSING_ABORTED")), Ct(t.ref.sub, t.query("GET_LABEL_TAP_TO_RETRY"))
                },
                DID_COMPLETE_ITEM_PROCESSING: function (e) {
                    var t = e.root;
                    Ct(t.ref.main, t.query("GET_LABEL_FILE_PROCESSING_COMPLETE")), Ct(t.ref.sub, t.query("GET_LABEL_TAP_TO_UNDO"))
                },
                ...
                DID_UPDATE_ITEM_LOAD_PROGRESS: kt,
                DID_THROW_ITEM_LOAD_ERROR: Xt,
                DID_THROW_ITEM_INVALID: Xt,
            ...
            create: function (e) {
                ...
                var r = wt("span");
                r.className = "filepond--file-status-sub", t.appendChild(r), t.ref.sub = r, kt({
                    root: t,
                    action: {
                        progress: null
                    }
    ...
    var Zt, $t = function (e) {
        ...
        ln = S({
            create: function (e) {
                var n, r = e.root,
                    o = e.props,
                    i = Object.keys(zt).reduce(function (e, t) {
                        return e[t] = Object.assign({}, zt[t]), e
                    }, {}),
                    a = o.id,
                ...
                var p = n ? Qt.filter(n) : Qt.concat();
                if (c && s && (i.RevertItemProcessing.label = "GET_LABEL_BUTTON_REMOVE_ITEM", i.RevertItemProcessing.icon = "GET_ICON_REMOVE"), f && !s) {
                    var E = an.DID_COMPLETE_ITEM_PROCESSING;
                    E.info.translateX = en, E.info.translateY = Jt, E.status.translateY = Jt, E.processingCompleteIndicator = {
                        opacity: 1,
                        scaleX: 1,
                        scaleY: 1
                    }
                ...
                if (f && !l && (["DID_START_ITEM_PROCESSING", "DID_REQUEST_ITEM_PROCESSING", "DID_UPDATE_ITEM_PROCESS_PROGRESS", "DID_THROW_ITEM_PROCESSING_ERROR"].forEach(function (e) {
                        an[e].status.translateY = Jt
                    }), an.DID_THROW_ITEM_PROCESSING_ERROR.status.translateX = Kt), d && s) {
                    i.RevertItemProcessing.align = "BUTTON_REMOVE_ITEM_POSITION";
                    var _ = an.DID_COMPLETE_ITEM_PROCESSING;
                    _.info.translateX = $t, _.status.translateY = Jt, _.processingCompleteIndicator = {
                        opacity: 1,
                        scaleX: 1,
                        scaleY: 1
                    }
                ...
                }), r.ref.processingCompleteIndicator = r.appendChildView(r.createChildView(sn)), r.ref.processingCompleteIndicator.element.dataset.align = r.query("GET_STYLE_BUTTON_PROCESS_ITEM_POSITION"), r.ref.info = r.appendChildView(r.createChildView(Yt, {
                    id: a
                })), r.ref.status = r.appendChildView(r.createChildView(Wt, {
                    id: a
                }));
                var T = r.appendChildView(r.createChildView(Ut, {
                    opacity: 0,
                ...
                var I = r.appendChildView(r.createChildView(Ut, {
                    opacity: 0,
        ...
        cn = S({
            create: function (e) {
                var t = e.root,
                    n = e.props;
                t.ref.fileName = wt("legend"), t.appendChild(t.ref.fileName), t.ref.file = t.appendChildView(t.createChildView(ln, {
                    id: n.id
                })), t.ref.data = !1
            },
            ignoreRect: !0,
            write: A({
                DID_LOAD_ITEM: function (e) {
                    var t = e.root,
                        n = e.props;
                    Ct(t.ref.fileName, Mt(t.query("GET_ITEM_NAME", n.id)))
                }
            }),
            didCreateView: function (e) {
                De("CREATE_VIEW", Object.assign({}, e, {
        ...
        yn = A({
            DID_ADD_ITEM: function (e) {
                ...
                t.ref.lastItemSpanwDate = s, t.appendChildView(t.createChildView(vn, {
                    spawnDate: s,
                    id: r,
                    opacity: u,
                    interactionMethod: i
            ...
            DID_DRAG_ITEM: function (e) {
                ...
                if (a) {
                    ...
                    gn.setHeight = d * _, gn.setWidth = p * E;
                    var T = {
                            y: Math.floor(f / d),
                            x: Math.floor(c / p),
                            getGridIndex: function () {
                                return f > gn.getHeight || f < 0 || c > gn.getWidth || c < 0 ? u : this.y * E + this.x
                            },
                ...
                if (0 !== u.length) {
                    ...
                    if (1 === m) {
                        ...
                        u.forEach(function (e, t) {
                            ...
                            o && (e.translateX = null, e.translateY = null), e.markedForRemoval || Rn(e, 0, h + g);
                        ...
                        u.forEach(function (e, t) {
                            ...
                            var n = t + p + f + d,
                                ...
                                u = Math.sign(a - R),
                                E = Math.sign(s - O);
                            R = a, O = s, e.markedForRemoval || (o && (e.translateX = null, e.translateY = null), Rn(e, a, s, u, E))
                        })
                    }
                }
            },
        ...
        Bn = S({
            ...
            create: function (e) {
                var t = e.root,
                    n = e.props;
                t.element.id = "filepond--browser-" + n.id, r(t.element, "name", t.query("GET_NAME")), r(t.element, "aria-controls", "filepond--assistant-" + n.id), r(t.element, "aria-labelledby", "filepond--drop-label-" + n.id), bn({
                    root: t,
                    action: {
        ...
        xn = S({
            ...
            create: function (e) {
                ...
                r(o, "for", "filepond--browser-" + n.id), r(o, "id", "filepond--drop-label-" + n.id), r(o, "aria-hidden", "true"), t.ref.handleKeyDown = function (e) {
                    (e.keyCode === qn || e.keyCode === Fn) && (e.preventDefault(), t.ref.label.click())
                }, t.ref.handleClick = function (e) {
                    e.target === o || o.contains(e.target) || t.ref.label.click()
                }, o.addEventListener("keydown", t.ref.handleKeyDown), t.element.addEventListener("click", t.ref.handleClick), Vn(o, n.caption), t.appendChild(o), t.ref.label = o
            },
            destroy: function (e) {
                var t = e.root;
        ...
        Qn = A({
            ...
            DID_ADD_ITEM: function (e) {
                var t = e.root,
                    ...
                    o = wt("input");
                o.type = r ? "file" : "hidden", o.name = t.query("GET_NAME"), o.disabled = t.query("GET_DISABLED"), t.ref.fields[n.id] = o, Wn(t)
            },
            DID_LOAD_ITEM: function (e) {
                var t = e.root,
                    n = e.action,
            ...
            DID_DEFINE_VALUE: function (e) {
                var t = e.root,
                    n = e.action,
                    r = Xn(t, n.id);
                r && (null === n.value ? r.removeAttribute("value") : r.value = n.value, Wn(t))
            },
        ...
        er = function () {
            var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "";
            return e = e.toLowerCase(), $n.includes(e) ? "image/" + ("jpg" === e ? "jpeg" : "svg" === e ? "svg+xml" : e) : Kn.includes(e) ? "text/" + e : Jn[e] || ""
        },
        tr = function (e) {
            return new Promise(function (t, n) {
                var r = fr(e);
                if (r.length && !nr(e)) return t(r);
                rr(e).then(t)
            })
        },
        nr = function (e) {
        ...
        ir = function (e) {
            return new Promise(function (t, n) {
                ur(e) ? ar(cr(e)).then(t).catch(n) : t([e.getAsFile()])
            })
        },
        ar = function (e) {
            return new Promise(function (t, n) {
        ...
        Ir = function (e) {
            ...
            var i = {
                ...
                addListener: function (a) {
                    return n.push(a),
                        function () {
                            n.splice(n.indexOf(a), 1), 0 === n.length && (Er.splice(Er.indexOf(i), 1), t(r, function (t) {
        ...
        gr = function (e, t) {
            return function (e) {
                e.preventDefault(), mr = e.target, t.forEach(function (t) {
                    var n = t.element,
                        r = t.onenter;
                    vr(e, n) && (t.state = "enter", r(_r(e)))
                })
            }
        },
        Rr = function (e, t) {
            return function (e) {
                ...
                tr(n).then(function (r) {
                    ...
                    t.some(function (t) {
                        ...
                        if (f)
                            if (vr(e, a)) {
                                if (o = !0, null === t.state) return t.state = "enter", void s(_r(e));
                                if (t.state = "over", i && !f) return void hr(n, "none");
                                l(_r(e))
                            } else i && !o && hr(n, "none"), t.state && (t.state = null, u(_r(e)));
                        else hr(n, "none")
                    })
                })
            }
                ...
                tr(n).then(function (n) {
                    t.forEach(function (t) {
                        var r = t.filterElement,
                            ...
                            a = t.onexit,
                            s = t.allowdrop;
                        if (t.state = null, !r || vr(e, o)) return s(n) ? void i(_r(e), n) : a(_r(e))
                    })
                })
            }
        },
        Dr = function (e, t) {
            return function (e) {
                mr === e.target && t.forEach(function (t) {
                    var n = t.onexit;
                    t.state = null, n(_r(e))
                })
            }
        ...
        Lr = function (e) {
            ...
            tr(e.clipboardData).then(function (e) {
        ...
        Pr = function () {
            var e = function (e) {
                ...
                t = {
                    destroy: function () {
                        var t;
                        t = e, de(Ar, Ar.indexOf(t)), 0 === Ar.length && (document.removeEventListener("paste", Lr), Sr = !1)
                    },
                    onload: function () {}
                };
            return function (e) {
                Ar.includes(e) || (Ar.push(e), Sr || (Sr = !0, document.addEventListener("paste", Lr)))
            }(e), t
        },
        br = null,
        Mr = null,
        ...
        Nr = function (e, t, n) {
            ...
            Cr(e, n + " " + t + ", " + r + " " + (1 === r ? e.query("GET_LABEL_FILE_COUNT_SINGULAR") : e.query("GET_LABEL_FILE_COUNT_PLURAL"))), clearTimeout(Mr), Mr = setTimeout(function () {
                ! function (e) {
        ...
        Br = function (e) {
            var t = e.root,
                n = e.action,
                r = t.query("GET_ITEM", n.id).filename;
            Cr(t, n.status.main + " " + r + " " + n.status.sub)
        },
        qr = S({
            create: function (e) {
                var t = e.root,
            ...
            write: A({
                DID_LOAD_ITEM: function (e) {
                    ...
                    if (Gr(t)) {
                        ...
                        wr.push(r.filename), clearTimeout(br), br = setTimeout(function () {
                            Nr(t, wr.join(", "), t.query("GET_LABEL_FILE_ADDED")), wr.length = 0
                        }, 750)
                    }
                },
                DID_REMOVE_ITEM: function (e) {
                    ...
                    if (Gr(t)) {
                        var r = n.item;
                        Nr(t, r.filename, t.query("GET_LABEL_FILE_REMOVED"))
                    }
                },
                DID_COMPLETE_ITEM_PROCESSING: function (e) {
                    var t = e.root,
                ...
                DID_ABORT_ITEM_PROCESSING: Ur,
                DID_REVERT_ITEM_PROCESSING: Ur,
        ...
        Zr = A({
            ...
            DID_SET_DISABLED: function (e) {
                var t = e.root,
                    n = e.props;
                Wr(t), Qr(t), zr(t, n), t.query("GET_DISABLED") ? t.element.dataset.disabled = "disabled" : t.element.removeAttribute("data-disabled")
            }
        }),
        $r = S({
            name: "root",
            ...
            create: function (e) {
                ...
                o && o.split(" ").filter(function (e) {
                    ...
                    name: "panel-root"
                })), t.ref.assistant = t.appendChildView(t.createChildView(qr, Object.assign({}, n))), t.ref.data = t.appendChildView(t.createChildView(Zn, Object.assign({}, n))), t.ref.measure = wt("div"), t.ref.measure.style.height = "100%", t.element.appendChild(t.ref.measure), t.ref.bounds = null, t.query("GET_STYLES").filter(function (e) {
                    return !M(e.value)
                }).map(function (e) {
                    var n = e.name,
                        r = e.value;
                ...
                t.query("GET_ALLOW_REORDER") && a && !i && (t.element.addEventListener("touchmove", xr, {
                    passive: !1
                }), t.element.addEventListener("gesturestart", xr));
            ...
            write: function (e) {
                ...
                if (Zr({
                    ...
                    var o = t.ref.bounds;
                    o || (o = t.ref.bounds = kr(t), t.element.removeChild(t.ref.measure), t.ref.measure = null);
                    var i = t.ref,
                        a = i.hopper,
                        s = i.label,
                        u = i.list,
                    ...
                    if (u.translateY = Math.max(0, m - u.rect.element.marginTop) - T.top, c) {
                        ...
                        I.visual > w ? u.overflow = w : u.overflow = null, t.height = y
            ...
            destroy: function (e) {
                var t = e.root;
                t.ref.paster && t.ref.paster.destroy(), t.ref.hopper && t.ref.hopper.destroy(), t.element.removeEventListener("touchmove", xr), t.element.removeEventListener("gesturestart", xr)
            },
            mixins: {
                styles: ["height"]
            }
            ...
            var p = $r(i, {
                ...
                D = function () {
                    ...
                    return new Promise(function (e, n) {
                        var r = [],
                            o = {};
                        if (b(t[0])) r.push.apply(r, t[0]), Object.assign(o, t[1] || {});
                        else {
                            var a = t[t.length - 1];
        ...
        eo = function (e) {
            ...
            var i = o.filter(function (e) {
                ...
                var o, i = r(e, n.name);
                return t[(o = n.name, Fr(o.replace(/^data-/, "")))] = i === n.name || i, t
            }, {});
        ...
        to = function () {
            return (arguments.length <= 0 ? void 0 : arguments[0]) instanceof HTMLElement ? function (e) {
                ...
                var r = Object.assign({}, t),
                    o = eo("FIELDSET" === e.nodeName ? e.querySelector("input[type=file]") : e, n);
            ...
            }.apply(void 0, arguments) : Jr.apply(void 0, arguments)
        },
        no = ["fire", "_read", "_write"],
        ro = function (e) {
            var t = {};
            return Ee(e, t, no), t
        },
            ...
            if (!lo.includes(e)) {
                ...
                var n, r = e({
                    ...
                    utils: {
                        ...
                        replaceInString: oo,
                        getExtensionFromFilename: ke,
                        getFilenameWithoutExtension: mt,
                        guesstimateMimeType: er,
                        getFileFromBlob: We,
                        getFilenameFromURL: je,
                        createRoute: A,
                        createWorker: io,
                        createView: S,
                        createItemAPI: Te,
        ...
        fo = (Zt = c() && !("[object OperaMini]" === Object.prototype.toString.call(window.operamini)) && "visibilityState" in document && "Promise" in window && "slice" in Blob.prototype && "URL" in window && "createObjectURL" in window.URL && "performance" in window && ("supports" in (window.CSS || {}) || /MSIE|Trident/.test(window.navigator.userAgent)), function () {
            return Zt
        }),
        po = {
            apps: []
        ...
        Eo = function () {};
    if (e.Status = {}, e.FileStatus = {}, e.FileOrigin = {}, e.OptionTypes = {}, e.create = Eo, e.destroy = Eo, e.parse = Eo, e.find = Eo, e.registerPlugin = Eo, e.getOptions = Eo, e.setOptions = Eo, fo()) {
        ! function (e, t) {
        ...
        "loading" !== document.readyState ? setTimeout(function () {
            return _o()
        }, 0) : document.addEventListener("DOMContentLoaded", _o);
        var To = function () {
            return t(Se(), function (t, n) {
                e.OptionTypes[t] = n[1]
            })
        };
        e.Status = Object.assign({}, Me), e.FileOrigin = Object.assign({}, ve), e.FileStatus = Object.assign({}, Ie), e.OptionTypes = {}, To(), e.create = function () {
            var t = to.apply(void 0, arguments);
            return t.on("destroy", e.destroy), po.apps.push(t), ro(t)
        }, e.destroy = function (e) {
            var t = po.apps.findIndex(function (t) {
                return t.isAttachedTo(e)
            });
            return t >= 0 && (po.apps.splice(t, 1)[0].restoreElement(), !0)
        }, e.parse = function (t) {
            ...
            return H(n) && (po.apps.forEach(function (e) {
                e.setOptions(n)
            }), function (e) {
                t(e, function (e, t) {
    ...
    e.supported = fo, Object.defineProperty(e, "__esModule", {
        value: !0
    })
});