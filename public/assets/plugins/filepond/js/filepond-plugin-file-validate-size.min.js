    ...
    var e = function (e) {
        ...
        return i("ALLOW_HOPPER_ITEM", function (e, i) {
            ...
            return new Promise(function (i, E) {
                ...
                if (t && !t(e)) return i(e);
                var I = l("GET_MAX_FILE_SIZE");
                if (null !== I && e.size >= I) E({
                    status: {
                        main: l("GET_LABEL_MAX_FILE_SIZE_EXCEEDED"),
                        sub: _(l("GET_LABEL_MAX_FILE_SIZE"), {
                            filesize: n(I, ".", l("GET_FILE_SIZE_BASE"))
                        })
                    }
                });
                else {
                    var a = l("GET_MIN_FILE_SIZE");
                    if (null !== a && e.size <= a) E({
                        status: {
                            main: l("GET_LABEL_MIN_FILE_SIZE_EXCEEDED"),
                            sub: _(l("GET_LABEL_MIN_FILE_SIZE"), {
                                filesize: n(a, ".", l("GET_FILE_SIZE_BASE"))
                            })
                        }
                    });
                    else {
                        ...
                        if (null !== u)
                            if (l("GET_ACTIVE_ITEMS").reduce(function (e, i) {
                                ...
                                status: {
                                    ...
                                    sub: _(l("GET_LABEL_MAX_TOTAL_FILE_SIZE"), {
                                        filesize: n(u)
                                    })
                                }
                            });
