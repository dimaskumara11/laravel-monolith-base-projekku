...
// $('body').append('' +
//     '<div class="fixed-button">' + '<a href="https://www.linkedin.com/in/hengki-setia-putra-094606135/" target="_blank" class="btn btn-md btn-primary">' + '<i class="fa fa-shopping-cart" aria-hidden="true"></i> Buy now' +
//     '</a> ' + '</div>' + '');
var $window = $(window);
